...
function addFileMessage(username, filename, sender) {
    ...
    switch (fileExtension) {
        case 'pdf':
            fileIcon = 'pdf-minimalistic-svgrepo-com.svg';
            break;
        case 'doc':
        case 'docx':
            fileIcon = 'doc-file-minimalistic-svgrepo-com.svg';
            break;
        case 'xls':
        case 'xlsx':
            fileIcon = 'excel-file-minimalistic-svgrepo-com.svg';
            break;
        default:
            fileIcon = 'default-file-svgrepo-com.svg';
    }

    const fileLink = document.createElement('a');
    fileLink.href = filename;
    fileLink.download = filename;
    fileLink.className = 'flex items-center space-x-2 text-white';
